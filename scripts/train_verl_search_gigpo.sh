...
# GiGPO-specific knobs. Defaults follow verl-agent's Search example, but the
# rest of the script mirrors train_verl_search_grpo.sh for a controlled compare.
GIGPO_MODE=${GIGPO_MODE:-mean_std_norm}
GIGPO_ENABLE_SIMILARITY=${GIGPO_ENABLE_SIMILARITY:-True}
GIGPO_SIMILARITY_THRESH=${GIGPO_SIMILARITY_THRESH:-0.9}
...
"$PYTHON" -m verl.trainer.main_ppo \
  ...
  trainer.experiment_name=qwen2_5_3b_lora_gigpo_sim_bm25 \
